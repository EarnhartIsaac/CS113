...
public class SingleLinkedList<E> extends SingleLinkedListAdapter<E> 
{
	private Node<E> head;
	private Node<E> tail;
	private int size;
	...
	{
		SingleListIterator temp = (SingleListIterator)this.listIterator();
		while(temp.hasNext())
		{
	...
	{
		SingleListIterator temp = (SingleListIterator)this.listIterator(size);
	...
	{
		return new SingleListIterator(0);
	}

	@Override
	public ListIterator<E> listIterator(int index) 
	{
		return new SingleListIterator(index);
	}
	...
	{
		SingleListIterator temp = (SingleListIterator)this.listIterator(index);
	...
	public class SingleListIterator implements ListIterator<E>
	{
		private Node<E> nextItem;
		private Node<E> lastItemReturned;
		private int index = 0;

		public SingleListIterator(int i) 
		{
			// error check index
			if (i < 0 || i > size) 
			{
